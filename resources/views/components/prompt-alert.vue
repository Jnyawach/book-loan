                ...
                <div class="bg-white md:w-3/5 lg:w-2/5 w-full rounded-3xl p-3">
                    <header class="p-3">
                        <div class="flex justify-center">
                            <div class="p-2">
                                <div class="flex justify-center">
                                    <div class="border-sky-600 rounded-full w-12 h-12 flex place-content-center
                                      items-center my-3  border-2">

                                        <svg class="fill-sky-600 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 512">
                    ...
                    <footer class="p-2 my-3">
                        <div class="flex justify-end gap-2">
                            <button class="btn-outline-primary font-medium" @click="show=false">Cancel</button>
                            <button class="btn-primary font-medium" @click="acceptAction">Okay</button>
                        </div>
                    </footer>
                </div>
            </div>
