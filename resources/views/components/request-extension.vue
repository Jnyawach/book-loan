                ...
                <div class="bg-white lg:w-1/2 w-full rounded-xl">
                    <header class="p-3 font-semibold text-lg">
                        <div class="flex justify-between items-center">
                            <div>
                                <h6 class="font-medium text-md">Request for extension</h6>
                            </div>
                            <div>
                                <div class="text-end">
                    ...
                    <div class="p-5">
                        <form @submit.prevent="requestExtension">
                            <p>Extension is charged at <span class="text-sky-600">KES 100</span> per day except for public holidays and weekends</p>
                            <div class="my-5">
                                <label class="sumo-label">Enter number of days you wish to extend:</label>
                                <input type="number" v-model="form.period" class="sumo-input my-2" step="1" min="1">
                                <div v-if="form.errors.period" class="sumo-error">
                                    <span>{{ form.errors.period }}</span>
                                </div>
                            </div>
                            <div v-if="form.period">
                                <p>Total cost: <span class="text-sky-600">KES {{ form.period * 100 }}</span></p>
                            </div>

                            <div class="my-3 flex justify-end">
                                <button :disabled="form.processing" type="submit" class="btn-primary  flex items-center gap-2 justify-center">
