...
const series=computed(()=>rating.value.total)
...
const getLeases= async ()=>{
    ...
    await axios.get(`/api/get/customer/rating`).then((response)=>{

        rating.value.label=response.data.label
        rating.value.total=response.data.data
        rateLoading.value=false
