...
<template>
    ...
    <section>
        <div class="h-screen flex place-content-center p-3">
            <div class="self-center border rounded-xl p-3 md:p-8 w-full md:w-3/5 lg:w-2/5 overflow-hidden bg-white shadow-xl">
                <h1 class="text-center font-bold text-xl text-sky-600">BOOK LOAN</h1>
                <h2 class="my-5 font-medium text-center">Create a new account</h2>
                <div class="my-5">
                    <form @submit.prevent="form.post('/auth/save')">
                        <div class="my-5 grid md:grid-cols-2 gap-3">
                            <div>
                                <label for="form-input-name" class="sumo-label">Name:</label>
                                <input type="text" class="sumo-input my-2" id="form-input-name" placeholder="Enter your name" required v-model="form.name"/>
                        ...
                        <div class="my-5 grid">
                           <div>
                            ...
                            <div>
                                <label for="form-password-confirm" class="sumo-label">Password:</label>
                                <input type="password" class="sumo-input my-2" id="form-password-confirm" placeholder="Confirm your password" required v-model="form.password_confirmation"/>
                        ...
                        <div class="my-5 grid gap-3 md:flex justify-center md:justify-between items-center">
                            <div class="order-2 md:order-1 text-center md:text-start ">
                                <Link href="/auth/login" class="hover:text-sky-700">Login here</Link>
                            </div>
